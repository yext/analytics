...
|  [type](./analytics.searchbarimpressionevent.type.md) | [EnumOrLiteral](./analytics.enumorliteral.md)<!-- -->&lt;[AnalyticsEventType.SearchBarImpression](./analytics.analyticseventtype.md)<!-- -->&gt; |  |
