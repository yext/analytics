...
|  [type](./analytics.voicesearchevent.type.md) | [EnumOrString](./analytics.enumorstring.md)<!-- -->&lt;[AnalyticsEventType.VoiceStart](./analytics.analyticseventtype.md) \| [AnalyticsEventType.VoiceStop](./analytics.analyticseventtype.md)<!-- -->&gt; | An enum member or its string value which denotes the event type. |
