...
|  [type](./analytics.thumbsfeedbackevent.type.md) | [EnumOrString](./analytics.enumorstring.md)<!-- -->&lt;[SearchAnalyticsEventType.ThumbsUp](./analytics.searchanalyticseventtype.md) \| [SearchAnalyticsEventType.ThumbsDown](./analytics.searchanalyticseventtype.md)<!-- -->&gt; | An enum member or its string value which denotes the event type. |
