...
|  [search?](./analytics.eventpayload.search.md) | { searchId: number; queryId: number; verticalKey?: string; directAnswer?: boolean; versionLabel?: string; versionNumber: number; experienceKey: string; } | <i>(Optional)</i> Fields specific to reporting Search Analytics Events |
