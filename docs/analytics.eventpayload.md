...
|  [search?](./analytics.eventpayload.search.md) | { searchId?: string; queryId?: string; verticalKey?: string; directAnswer?: boolean; versionLabel?: VersionLabel; versionNumber: number; experienceKey: string; } | <i>(Optional)</i> Fields specific to reporting Search Analytics Events |
