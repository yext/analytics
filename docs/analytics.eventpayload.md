...
|  [search?](./analytics.eventpayload.search.md) | { searchId: number; queryId: number; verticalKey?: string; directAnswer?: boolean; versionLabel?: VersionLabel; versionNumber: number; experienceKey: string; } | <i>(Optional)</i> Fields specific to reporting Search Analytics Events |
