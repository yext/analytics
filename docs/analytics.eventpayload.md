...
|  [bot?](./analytics.eventpayload.bot.md) | string | <i>(Optional)</i> Whether the event is the result of bot activity. |
...
|  [destinationUrl?](./analytics.eventpayload.destinationurl.md) | string | <i>(Optional)</i> The URI of the page the event is directing the visitor to. |
...
|  [pageUrl?](./analytics.eventpayload.pageurl.md) | string | <i>(Optional)</i> The URI of the page where the event occurred |
|  [referrerUrl?](./analytics.eventpayload.referrerurl.md) | string | <i>(Optional)</i> The URI of the page which the visitor came from prior to the event. |
