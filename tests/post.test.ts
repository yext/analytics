...
describe('Test post util function', () => {
  ...
  it('should send fetch request', async () => {
    ...
    expect(
      fetchMock.calls('https://dev.us.yextevents.com/accounts/me/events')
        .length,
    ).toEqual(1);
    expect(
      fetchMock.calls('https://dev.us.yextevents.com/accounts/me/events')[0][1],
    ).toEqual(optionsA);
    ...
    expect(
      fetchMock.calls('https://dev.us.yextevents.com/accounts/me/events')[1][1],
    ).toEqual(optionsA);
    ...
    expect(
      fetchMock.calls('https://dev.us.yextevents.com/accounts/me/events')[2][1],
    ).toEqual(optionsA);
